//! Various styles for the [`WaveView`] widget
//!
//! [`WaveView`]: ../../native/wave_view/struct.WaveView.html

use iced::Color;

use crate::style::default_colors;

/// The appearance of an [`WaveView`].
///
/// [`WaveView`]: ../../native/wave_view/struct.WaveView.html
...
pub struct Style {
    ...
    /// The color of the left/mono plot
    pub left_plot_color: Color,
    /// The color of the right plot
    pub right_plot_color: Color,

    /// The width (thickness) of the left/mono plot
    pub left_plot_width: f32,
    /// The width (thickness) of the right plot
...
/// A set of rules that dictate the style of an [`WaveView`].
///
/// [`WaveView`]: ../../native/wave_view/struct.WaveView.html
pub trait StyleSheet {
    /// Produces the style of an [`WaveView`].
    ///
    /// [`WaveView`]: ../../native/wave_view/struct.WaveView.html
    fn style(&self) -> Style;
}
